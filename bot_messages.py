...
help_command_response = "Доступные команды:" \
                        ...
                        "\n" \
                        "8. /enter_chat - войти в анонимный чат" \
                        "\n" \
                        "9. /set_webwork_password - обновление пароля от webwork'ов" \
                        "\n" \
                        "10. /notify_webwork - включение уведомлений о новых webwork'ах" \
                        "\n" \
                        "11. /feedback - сообщить о баге, предложить новый функционал" \
                        "\n" \
                        "12. /help - список всех доступных команд"
